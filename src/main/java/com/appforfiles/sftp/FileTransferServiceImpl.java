...
public class FileTransferServiceImpl implements FileTransferService {
	 ...
	 */
	@Override
	public boolean uploadFileWithPassword(String localFilePath, String remoteFilePath) {

		ChannelSftp channelSftp = createChannelSftpPassword();
	 ...
	 * @return
	 */
	private ChannelSftp createChannelSftpPassword() {
		try {
			JSch jSch = new JSch();
